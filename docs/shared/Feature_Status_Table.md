...
| **MSG_CMD_BOOTLOADER**             | ✅     | `main.c`               | Bootloader entry command                               |
| **Heartbeat/Ping**                 | ✅     | `protocol.c`           | Connection monitoring                                  |
| **Error Handling**                 | ✅     | `protocol.c`           | CRC errors, timeouts, error tracking                   |
| **ACK Result Codes**               | ✅     | `protocol.c`, `main.c` | Success/invalid/rejected/failed/timeout/busy/not_ready |
| **Protocol Error Tracking**        | ✅     | `protocol.c`           | CRC/packet error counters, error reset                 |
| **OTA Firmware Update (ESP32)**    | ✅     | `web_server.cpp`       | File upload, chunked streaming, progress reporting     |
| **OTA Firmware Update (Pico)**     | ✅     | `bootloader.c`         | Serial bootloader, checksum verify, flash write        |
