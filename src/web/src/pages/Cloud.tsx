...
export function Cloud() {
  ...
  // Fetch cloud status from device
  ...
  // Load pairing QR and cloud status on mount
  useEffect(() => {
    fetchPairingQR();
    fetchCloudStatus();
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-coffee-900">Cloud Connection</h1>
        <p className="text-coffee-500 mt-1">
          Connect your machine to BrewOS Cloud for remote access
        </p>
      </div>
          ...
          <Card>
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-coffee-100 rounded-lg">
                <CloudIcon className="w-5 h-5 text-coffee-600" />
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <Button 
                ...
                loading={saving}
                disabled={!cloudEnabled && !cloudConfig?.enabled}
                className="w-full"
              >
                Save Settings
              </Button>
