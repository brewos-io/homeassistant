...
export function TimeSettings() {
  ...
  const getTimezoneLabel = (offsetMinutes: number) => {
    ...
    return (
      tz?.label || `UTC${offsetMinutes >= 0 ? "+" : ""}${offsetMinutes / 60}`
    );
  };
      ...
      {!editing ? (
        ...
        <div className="space-y-0">
          <div className="flex items-center justify-between py-2 border-b border-theme">
            ...
            <span className="text-sm font-medium font-mono text-theme">
              {settings.ntpServer}
            </span>
          </div>
          <div className="flex items-center justify-between py-2 border-b border-theme">
            ...
            <span className="text-sm font-medium text-theme">
              {getTimezoneLabel(settings.utcOffsetMinutes)}
            </span>
          </div>
          <div className="flex items-center justify-between py-2 border-b border-theme">
        ...
        <div>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                updatePreference("use24HourTime", e.target.checked)
              }
    ...
    <Card>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              updatePreference(
                "currency",
                e.target.value as UserPreferences["currency"]
              )
            }
        ...
        <div>
          ...
          <p className="mt-1.5 text-xs text-theme-muted">
            Your local electricity rate per kilowatt-hour. Check your utility
            bill for accurate pricing.
          </p>
        </div>
      </div>
    </Card>
