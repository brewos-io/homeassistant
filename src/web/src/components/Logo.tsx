...
export function Logo({
  ...
  return (
    <div className={cn("flex items-center", sizeConfig.gap, className)}>
      ...
      <LogoText className={cn(sizeConfig.text, "w-auto")} fill={textFill} />
    </div>
  );
}
