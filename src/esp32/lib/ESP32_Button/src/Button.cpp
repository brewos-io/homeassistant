...
Button::Button(gpio_num_t pin, bool pullup)
{
    ...
    // With pullup: button pressed = LOW (0), so active_level = 0
    // With pulldown: button pressed = HIGH (1), so active_level = 1
    button_config_t cfg = {
        ...
        .gpio_button_config = {
            ...
            .active_level = pullup ? 0 : 1 // pullup = active LOW, pulldown = active HIGH
        }
    };
