...
#define CONFIG_BUTTON_DEBOUNCE_TICKS 3                  //range  1 8 (increased for better debounce)
#define CONFIG_BUTTON_SHORT_PRESS_TIME_MS 100           //range  50-800 (reduced for faster click detection)
#define CONFIG_BUTTON_LONG_PRESS_TIME_MS 1500           //range  500-5000 (increased to 2 seconds)
